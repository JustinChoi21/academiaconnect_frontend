...
const ProposalContent = () => (
  <div style={styles.container}>
    ...
    <h2 style={styles.heading2}><strong>1. Problem Statement</strong></h2>
    <p style={styles.paragraph}>
    ...
    <h2 style={styles.heading2}><strong>2. User’s Goals, Actions, and Potential Obstacles</strong></h2>

    <h3 style={styles.heading3}>1) User’s Goals:</h3>
    ...
    <h3 style={styles.heading3}>2) User’s Actions:</h3>
    <ul style={styles.list}>
      <li><strong>Students:</strong>
        <ul style={styles.innerList}>
    ...
    <h3 style={styles.heading3}>3) Potential Obstacles:</h3>
    <ul style={styles.list}>
